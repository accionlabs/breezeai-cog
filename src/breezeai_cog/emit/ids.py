...
unique MERGE key) and also uses ``parentId`` to wire containment edges. It only needs
 to be unique within a file — :func:`disambiguate` adds a deterministic ordinal on the rare
