...
import time
from factory import InfraStream
...
#     settings: Settings,
# ) -> Any:
#     """Execute an S3 operation and retry after a connection failure."""

#     for attempt in range(settings.s3_retry_attempts):
#         try:
#             return operation()
...
#             ReadTimeoutError,
#         ):
#             if attempt == settings.s3_retry_attempts - 1:
#                 raise
